...
Create your own forked copy of `gitwash`_
======================================================

#. Log into your github account.
#. Go to the `gitwash`_ github home at `gitwash github`_.
#. Click on the *fork* button:

   .. image:: forking_button.png

   Now, after a short pause and some 'Hardcore forking action', you
   should find yourself at the home page for your own forked copy of `gitwash`_.
