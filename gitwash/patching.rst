...
Then, send the generated patch files to the `gitwash
...
#. Finally, make your commits into patches.  You want all the
   ...
   Send these files to the `gitwash mailing list`_.
...
Fork the gitwash_ repository on github_ |emdash| :ref:`forking`.
Then::
   ...
   git remote add origin git@github.com:your-user-name/gitwash.git
